...
type DataAccessCodingAdvanceWithoutNewKeyword=
  static member GetCode (tableRelatedInfos:TableRelatedInfo seq)=  //static member GetCode (typedTableNames:(string*TableTemplateType) list)=
    ...
    try
      DataAccessCodingAdvanceWithoutNewKeyword.GenerateNamespaceCode
      |>string|>sb.Append|>ignore
      for a in tableRelatedInfos do
        DataAccessCodingAdvanceWithoutNewKeyword.GenerateTypeCode a.TableName
        |>string|>sb.Append|>ignore
        match a.TableTemplateType with
        | MainTableWithOneLevel ->
            DataAccessCodingAdvanceWithoutNewKeyword.GetCodeWithMainChildTableOneLevelTemplate a.TableName a.LevelOneChildTableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | MainTableWithTwoLevels ->
            DataAccessCodingAdvanceWithoutNewKeyword.GetCodeWithMainChildTableTwoLevelTemplate a.TableName a.LevelOneChildTableName a.LevelTwoChildTableName 
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | IndependentTable ->
            DataAccessCodingAdvanceWithoutNewKeyword.GetCodeWithIndependentTable a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | ChildTable ->  //只能查询当前表和叶子表信息
            DataAccessCodingAdvanceWithoutNewKeyword.GetCodeWithChildTableTemplate a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | LeafTable -> //只能查询当前表
            DataAccessCodingAdvanceWithoutNewKeyword.GetCodeWithLeafTableTemplate a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | _ ->()
      string sb
  ...
  static member private GetCodeWithLeafTableTemplate (tableName:string)=
    ...
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateQueryCodeForLeafTable tableName tableColumns tableAsFKRelationships tableAsPKRelationships
  ...
  static member private GetCodeWithIndependentTable (tableName:string)=
    ...
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateQueryCodeForIndependentTable tableName tableColumns tableAsFKRelationships tableAsPKRelationships
    |>box|>sb.Append |>ignore //QueryCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateCreateCodeForIndependentTable  tableName tableColumns tableAsFKRelationships tableAsPKRelationships tableKeyColumns
    |>box|>sb.Append |>ignore //CreateCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateUpdateCodeForIndependentTable  tableName tableColumns tableAsFKRelationships tableAsPKRelationships tableKeyColumns
    |>box|>sb.Append |>ignore //UpdateCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateDeleteCodeForIndependentTable  tableName tableKeyColumns
    |>box|>sb.Append |>ignore //Delete
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateMultiDeleteCodeForIndependentTable  tableName tableKeyColumns
  ...
  static member private GetCodeWithMainChildTableOneLevelTemplate (mainTableName:string) (childTableName:string)=
    ...
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateQueryCodeForMainChildOneLevelTables mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //QueryCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateCreateCodeForMainChildOneLevelTables  mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships mainTableKeyColumns childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //CreateCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateUpdateCodeForMainChildOneLevelTables  mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships mainTableKeyColumns childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //UpdateCode
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateDeleteCodeForMainChildOneLevelTables  mainTableName mainTableKeyColumns childTableName
    |>box|>sb.Append |>ignore //Delete
    sb.AppendLine()|>ignore
    DataAccessCodingAdvanceWithoutNewKeyword.GenerateMultiDeleteCodeForMainChildOneLevelTables  mainTableName mainTableKeyColumns childTableName
    |>box|>sb.Append |>ignore //MultiDelete
    sb.AppendLine()|>ignore
    string sb
...
///////////////////////////////////////////
                ...
                *)
                ...
                y|>Seq.iteri (fun a _ ->
                  sbTemSub.AppendFormat(@"{0},"
                    ,
                    //{0}
                    string DataAccessCodingAdvanceWithoutNewKeyword.VariableNames.[a]
                    )|>ignore)
                match sbTemSub with
                | w when w.Length>0 ->w.Remove(w.Length-1,1)|>ignore //Remove the last of ','
                | _ ->()
                ...
                y|>Seq.iteri (fun a b ->
                  ...
                  | _,v  when v.DATA_TYPE.ToLowerInvariant().EndsWith("string")  || v.DATA_TYPE.EndsWith("[]") ->
                      sbTemSub.AppendFormat(@"{0} && "
                        ,
                        //{0}
                        string DataAccessCodingAdvanceWithoutNewKeyword.VariableNames.[a]+"<>null"
                        )|>ignore
                  | _  ->
                      sbTemSub.AppendFormat(@"{0} && " 
                        ,
                        //{0}
                        string DataAccessCodingAdvanceWithoutNewKeyword.VariableNames.[a]+".HasValue"
                         )|>ignore)
                match sbTemSub with
  ...
  static member private GenerateUpdateCodeForMainChildOneLevelTables (mainTableName:string)   (mainTableColumns:DbColumnSchemalR seq) (mainTableAsFKRelationships:DbFKPK list) (mainTableAsPKRelationships:DbFKPK list) (mainTableKeyColumns:DbPKColumn seq)  (childTableName:string)  (childTableColumns:DbColumnSchemalR seq) (childTableAsFKRelationships:DbFKPK list) (childTableAsPKRelationships:DbFKPK list)=
    try
      let sbTem=StringBuilder()
      let sbTemSub=StringBuilder()
      let sb=StringBuilder()
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  static member private GenerateCreateCodeForIndependentTable (tableName:string)  (tableColumns:DbColumnSchemalR seq) (tableAsFKRelationships:DbFKPK list) (tableAsPKRelationships:DbFKPK list) (tableKeyColumns:DbPKColumn seq) =
    try
      let sbTem=StringBuilder()
      let sbTemSub=StringBuilder()
      let sb=StringBuilder()
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  static member private GenerateUpdateCodeForIndependentTable   (tableName:string)   (tableColumns:DbColumnSchemalR seq) (tableAsFKRelationships:DbFKPK list) (tableAsPKRelationships:DbFKPK list) (tableKeyColumns:DbPKColumn seq) =
    try
      let sbTem=StringBuilder()
      let sbTemSub=StringBuilder()
      let sb=StringBuilder()
