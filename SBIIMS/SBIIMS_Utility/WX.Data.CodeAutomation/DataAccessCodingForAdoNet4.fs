...
type DataAccessCodingForAdoNet4=
  static member GetCode (tableRelatedInfos:TableRelatedInfo seq)=  //static member GetCode (typedTableNames:(string*TableTemplateType) list)=
    ...
    try
      DataAccessCodingForAdoNet4.GenerateNamespaceCode
      |>string|>sb.Append|>ignore
      for a in tableRelatedInfos do
        DataAccessCodingForAdoNet4.GenerateTypeCode a.TableName
        |>string|>sb.Append|>ignore
        match a.TableTemplateType with
        | MainTableWithOneLevel ->
            DataAccessCodingForAdoNet4.GetCodeWithMainChildTableOneLevelTemplate a.TableName a.LevelOneChildTableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | MainTableWithTwoLevels ->
            DataAccessCodingForAdoNet4.GetCodeWithMainChildTableTwoLevelTemplate a.TableName a.LevelOneChildTableName a.LevelTwoChildTableName 
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | IndependentTable ->
            DataAccessCodingForAdoNet4.GetCodeWithIndependentTable a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | ChildTable ->  //只能查询当前表和叶子表信息
            DataAccessCodingForAdoNet4.GetCodeWithChildTableTemplate a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | LeafTable -> //只能查询当前表
            DataAccessCodingForAdoNet4.GetCodeWithLeafTableTemplate a.TableName
            |>string |>sb.Append |>ignore
            sb.AppendLine()|>ignore
        | _ ->()
      string sb
  ...
  static member private GetCodeWithLeafTableTemplate (tableName:string)=
    ...
    DataAccessCodingForAdoNet4.GenerateQueryCodeForLeafTable tableName tableColumns tableAsFKRelationships tableAsPKRelationships
  ...
  static member private GetCodeWithIndependentTable (tableName:string)=
    ...
    DataAccessCodingForAdoNet4.GenerateQueryCodeForIndependentTable tableName tableColumns tableAsFKRelationships tableAsPKRelationships
    |>box|>sb.Append |>ignore //QueryCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateCreateCodeForIndependentTable  tableName tableColumns tableAsFKRelationships tableAsPKRelationships tableKeyColumns
    |>box|>sb.Append |>ignore //CreateCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateUpdateCodeForIndependentTable  tableName tableColumns tableAsFKRelationships tableAsPKRelationships tableKeyColumns
    |>box|>sb.Append |>ignore //UpdateCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateDeleteCodeForIndependentTable  tableName tableKeyColumns
    |>box|>sb.Append |>ignore //Delete
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateMultiDeleteCodeForIndependentTable  tableName tableKeyColumns
  ...
  static member private GetCodeWithMainChildTableOneLevelTemplate (mainTableName:string) (childTableName:string)=
    ...
    DataAccessCodingForAdoNet4.GenerateQueryCodeForMainChildOneLevelTables mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //QueryCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateCreateCodeForMainChildOneLevelTables  mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships mainTableKeyColumns childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //CreateCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateUpdateCodeForMainChildOneLevelTables  mainTableName mainTableColumns mainTableAsFKRelationships mainTableAsPKRelationships mainTableKeyColumns childTableName childTableColumns childTableAsFKRelationships childTableAsPKRelationships 
    |>box|>sb.Append |>ignore //UpdateCode
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateDeleteCodeForMainChildOneLevelTables  mainTableName mainTableKeyColumns childTableName
    |>box|>sb.Append |>ignore //Delete
    sb.AppendLine()|>ignore
    DataAccessCodingForAdoNet4.GenerateMultiDeleteCodeForMainChildOneLevelTables  mainTableName mainTableKeyColumns childTableName
    |>box|>sb.Append |>ignore //MultiDelete
    sb.AppendLine()|>ignore
    string sb
        ...
        | {1} when {2} ->",
                ...
                y|>Seq.iteri (fun a _ ->
                  sbTemSub.AppendFormat(@"{0},"
                    ,
                    //{0}
                    string DataAccessCodingForAdoNet4.VariableNames.[a]
                    )|>ignore)
                match sbTemSub with
                | w when w.Length>0 ->w.Remove(w.Length-1,1)|>ignore //Remove the last of ','
                | _ ->()
                ...
                y|>Seq.iteri (fun a b ->
                  ...
                  | _,v  when v.DATA_TYPE.ToLowerInvariant().EndsWith("string")  || v.DATA_TYPE.EndsWith("[]") ->
                      sbTemSub.AppendFormat(@"{0}<>null && "
                        ,
                        //{0}
                        string DataAccessCodingForAdoNet4.VariableNames.[a]
                        )|>ignore
                  | _  ->
                      sbTemSub.AppendFormat(@"{0}.HasValue && " 
                        ,
                        //{0}
                        string DataAccessCodingForAdoNet4.VariableNames.[a]
                         )|>ignore)
