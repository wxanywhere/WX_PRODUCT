...
type WcfClientChannelFromServerCoding=
  ...
  static member public INS= WS_{0}Channel()"
    ...
    for a in tableRelatedInfos do
      ...
      | MainTableWithTwoLevels->
          WcfClientChannelFromServerCoding.GetCodeWithTemplateOne a.TableName
          |>string |>sb.Append |>ignore
          sb.AppendLine()|>ignore
      | IndependentTable ->
          match a.ColumnConditionTypes with
          | ColumnConditionTypeContains [HasXH] _ ->
              WcfClientChannelFromServerCoding.GetCodeWithTemplateThree a.TableName
              |>string |>sb.Append |>ignore
              sb.AppendLine()|>ignore
          | _ ->
              WcfClientChannelFromServerCoding.GetCodeWithTemplateOne a.TableName
      ...
      | ChildTable 
      | LeafTable -> 
          WcfClientChannelFromServerCoding.GetCodeWithTemplateTwo a.TableName
          |>string |>sb.Append |>ignore
          sb.AppendLine()|>ignore
      | _ ->()
    string sb
